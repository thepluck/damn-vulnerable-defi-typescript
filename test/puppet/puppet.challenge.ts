...
describe('[Challenge] Puppet', function () {
  it('should take all tokens from the lending pool', async function () {
    ...
    const UniswapExchangeFactory = await ethers.getContractFactory('UniswapV1Exchange', deployer);
    ...
    const uniswapFactory = await (await ethers.getContractFactory('UniswapV1Factory', deployer)).deploy();
